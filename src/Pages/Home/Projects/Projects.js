        ...
        <div id="project" className="bg-primary">
            <section className=" md:mx-36 mx-2">
               ...
               <div className="grid grid-cols-1 gap-6 md:grid-cols-3 text-secondary font-sans ">
                    <div  data-aos="flip-right" className=" projects-box ">
                            ...
                            " href="https://glasses-store-for-everyone.web.app/home" target="blank" >Website</a>
                            <a className="border-2 p-1 rounded-lg text-secondary   
                             hover:bg-secondary hover:text-primary 
                            " href="https://github.com/ashfak101/glaass-store" target="blank">GitHub</a>
                            </div>
                    </div>
                    <div className="projects-box">
                            ...
                            <a className="mr-6 border-2 p-1 rounded-lg text-secondary   
                             hover:bg-secondary hover:text-primary 
                            " href="https://windy-holiday-planners.web.app/home" target="blank">Website</a>
                            <a className="border-2 p-1 rounded-lg text-secondary   
                             hover:bg-secondary hover:text-primary 
                            " href="https://github.com/ashfak101/windy-planner-client" target="blank">GitHub</a>
                            </div>
                    </div>
                    <div data-aos="flip-left" className="projects-box">
                           ...
                           <h2 className="text-xl font-medium uppercase text-main my-2">DenttCare Solution</h2>
                            ...
                            <a className="mr-6 border-2 p-1 rounded-lg text-secondary   
                             hover:bg-secondary hover:text-primary 
                            " href="https://denttcare-solution.web.app/" target="blank">Website</a>
                            <a className="border-2 p-1 rounded-lg text-secondary   
                             hover:bg-secondary hover:text-primary 
                            " href="https://github.com/ashfak101/DENTTCARE-SOLUTION" target="blank">GitHub</a>
                            </div>
                    </div>
               </div>
            </section>
